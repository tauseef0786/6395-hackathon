...
const Nutrition = () => {
  return (
    <div className="bg-gradient-to-b from-white to-blue-300">
      ...
      <h2 className="text-3xl md:text-5xl text-center mt-24 font-bold text-violet-700 mb-4">
        The Importance of Nutritional Food
      </h2>
      <div className="min-h-screen flex flex-col md:flex-row items-center justify-between px-6 py-12">
        {/* Left Side - Image */}
      ...
      {/* Section 2 - Why We Should Keep Track of Our Calories and Nutrition */}
          <h2 className="text-2xl md:text-5xl text-center mt-16 mb-0 font-bold text-violet-700">
            Why We Should Keep Track of Our Calories and Nutrition
          </h2>
      <div className="min-h-screen bg-gradient-to-t from-white to-blue-150 flex flex-col md:flex-row items-center justify-between px-6 mt-0">
        {/* Left Side - Text */}
